...
import type { AddExerciseSchema } from "./add-exercises";
	...
	const handleInputChange = (
		...
		const updatedItems = items.map((item) => {
			if (item.id === id) {
				...
				if (fieldKey === "sets") {
					updatedItem.sets = Number.parseInt(value as string, 10) || 0;
				} else if (fieldKey === "reps") {
					updatedItem.reps = Number.parseInt(value as string, 10) || 0;
				}
